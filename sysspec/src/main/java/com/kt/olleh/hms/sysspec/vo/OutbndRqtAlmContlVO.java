...
public class OutbndRqtAlmContlVO extends HomeCameraOutbndVO {
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtAlmContlVO.Response.class);
