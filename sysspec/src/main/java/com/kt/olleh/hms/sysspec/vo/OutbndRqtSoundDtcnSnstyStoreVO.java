...
public class OutbndRqtSoundDtcnSnstyStoreVO extends HomeCameraOutbndVO {
	...
	@RowExtensionHint(rowExtension = RowExtension.V_SENSITIVITY)
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtSoundDtcnSnstyStoreVO.Response.class);
