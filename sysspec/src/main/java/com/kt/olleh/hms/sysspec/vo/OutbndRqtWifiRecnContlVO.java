...
public class OutbndRqtWifiRecnContlVO extends HomeCameraOutbndVO {
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtWifiRecnContlVO.Response.class);
