...
public class OutbndRqtRestartContlVO extends HomeCameraOutbndVO {
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtRestartContlVO.Response.class);
