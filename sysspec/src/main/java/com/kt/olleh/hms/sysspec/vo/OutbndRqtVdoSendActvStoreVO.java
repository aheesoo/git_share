...
public class OutbndRqtVdoSendActvStoreVO extends HomeCameraOutbndVO {
	...
	@RowExtensionHint(rowExtension = RowExtension.STATUS)
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtVdoSendActvStoreVO.Response.class);
