...
public final class OutbndRqtIntgSetupRetvVO extends HomeCameraOutbndVO {

	private static final Logger logger = LoggerFactory.getLogger(OutbndRqtIntgSetupRetvVO.class);

	public OutbndRqtIntgSetupRetvVO() {
		super();
	}

	OutbndRqtIntgSetupRetvVO(byte[] dataBytes) {
		super(dataBytes);
	}
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtIntgSetupRetvVO.Response.class);
		...
		@FieldHint(index = 1, length = 4, minVer = 0.82f)
		...
		@FieldHint(index = 14, length = 4, minVer = 0.82f)
		private Integer Scheduled;

		@FieldHint(index = 15, length = 10, minVer = 0.82f)
		private String FirmwareVersion;

		@FieldHint(index = 16, length = 32, minVer = 0.82f)
		private String APName;

		@FieldHint(index = 17, length = 10, minVer = 0.82f)
		...
		@FieldHint(index = 25, length = 4, minVer = 0.82f)
