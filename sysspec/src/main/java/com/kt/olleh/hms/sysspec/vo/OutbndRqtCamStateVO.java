...
public class OutbndRqtCamStateVO extends HomeCameraOutbndVO {
	...
	private Integer StateCheckCode;

	public void setStateCheckCode(int stateCheckCode) {
		StateCheckCode = stateCheckCode;
	}

	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtCamStateVO.Response.class);
