...
public class OutbndRqtMtnDtcnPushIntvlStoreVO extends HomeCameraOutbndVO {
	...
	@RowExtensionHint(rowExtension = RowExtension.MOVING_PNS)
	...
	public static final class Response extends HomeCameraInbndVO {
		private static final Logger logger = LoggerFactory.getLogger(OutbndRqtMtnDtcnPushIntvlStoreVO.Response.class);
